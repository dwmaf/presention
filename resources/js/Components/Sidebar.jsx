...
function Sidebar() {
    return (
        <div className="bg-white w-64 flex flex-col gap-4 pt-8 fixed top-0 left-0 bottom-0 z-50 shadow-lg">
            <div className="flex gap-2 items-center px-8  rounded-md ">
                <img
            ...
            <nav className="h-full">
                <ul className="flex flex-col h-full px-4">
                    <li>
                        <Link
                    ...
                    <li>
                        ...
                        >
                            ...
                            <p className="font-medium pt-1">Daftar Karyawan</p>
                        </Link>
                    </li>
                    ...
                    <li className="mt-auto">
                        <Link
                            ...
                            method="post"
                            as="button"
                            className="flex items-center px-4 py-4 gap-4 hover:bg-red-100 text-gray-400 hover:text-red-700 transition-colors rounded-md w-full mb-4"
                        >
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="20"
